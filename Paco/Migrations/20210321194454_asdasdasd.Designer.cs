...
namespace Paco.Migrations
{
    ...
    [Migration("20210321194454_asdasdasd")]
            ...
            modelBuilder.Entity("Paco.Entities.Models.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("31886026-b79e-4d94-b9ef-341178d39a26"),
                            ConcurrencyStamp = "a7ff268d-955f-4e05-b1ef-695ecbcdcc7d",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Paco.Entities.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69dc6c0c-61be-425c-83d7-d1c44be54952"),
                            AccessFailedCount = 0,
            ...
            modelBuilder.Entity("Paco.Entities.Models.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ecaf7bb5-6c75-47d0-b550-498341aae899"),
                            UserId = new Guid("69dc6c0c-61be-425c-83d7-d1c44be54952"),
                            RoleId = new Guid("31886026-b79e-4d94-b9ef-341178d39a26")
                        });
                });
            ...
            modelBuilder.Entity("Paco.Entities.Models.ManagedSystem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8f7533d4-5061-4d0e-96dd-11312de7167a"),
                            Distribution = 0,
                        ...
                        new
                        {
                            Id = new Guid("a933bfbb-de1c-46ef-af6a-887adb219dbc"),
                            Distribution = 0,
            ...
            modelBuilder.Entity("Paco.Entities.Models.RoleManagedSystemPermissions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c9d14fd7-0dc4-4929-8006-5a479d3e9fd8"),
                            RoleId = new Guid("31886026-b79e-4d94-b9ef-341178d39a26"),
                            ManagedSystemId = new Guid("8f7533d4-5061-4d0e-96dd-11312de7167a"),
                            Permissions = (short)0
                        },
                        new
                        {
                            Id = new Guid("d478527d-2168-4cbf-b234-07e0e5069ceb"),
                            RoleId = new Guid("31886026-b79e-4d94-b9ef-341178d39a26"),
                            ManagedSystemId = new Guid("a933bfbb-de1c-46ef-af6a-887adb219dbc"),
                            Permissions = (short)7
                        });
                });
